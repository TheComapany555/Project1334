...
import { getAgencyPayments } from "@/lib/actions/payments";
import {
...
export default async function AgencyPaymentsPage() {
  ...
  if (session?.user?.agencyRole !== "owner") {
    redirect("/dashboard");
  }

  const payments = await getAgencyPayments();
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Payment activity and revenue insights for your agency."
      />
