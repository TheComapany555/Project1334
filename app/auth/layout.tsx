  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-muted/40 px-4 py-8 sm:p-6 relative">
      ...
      <Link href="/" className="mb-6 shrink-0" aria-label="Salebiz home">
        <Image src="https://g44yi0ry58orcc8h.public.blob.vercel-storage.com/Salebizsvg.svg" alt="Salebiz" width={140} height={42} className="h-9 w-auto object-contain sm:h-10" priority />
      </Link>
